...
This repository contains the code for Edward Gunning's thesis Chapters 1 and 2.

* The $\textsf{R}$ code to generate the examples and create the figures are contained in the [code](code) folder :open_file_folder:.
